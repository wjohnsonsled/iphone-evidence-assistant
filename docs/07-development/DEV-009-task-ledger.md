...
| DEV-0605 | Relative-path normalization | READY | DEV-0602; DEV-0604; autonomous Manifest authorization | To be created | Candidate-only lexical path semantics authorized; no joining, repair, filesystem access, existence, artifact, or support inference |
