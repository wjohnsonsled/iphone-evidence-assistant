...
| DEV-0602A | Files-table query hardening and resource-control profile | VALIDATION_PENDING | DEV-0602; DEC-0061 | DEV-0602A-files-query-hardening-acceptance; FOR-013; QMS-012 | Candidate query v2 and resource-controls v1; v1 immutable; owner approval required for completion; no interpretation/support |
| DEV-0603 | FileID normalization | OWNER_REVIEW | DEV-0602 | To be created | FILEID-NORMALIZATION-GATE: syntax, case, length, raw preservation, invalid/missing behavior, comparison, and locator relationship require approval |
| DEV-0604 | Domain normalization | OWNER_REVIEW | DEV-0602 | To be created | DOMAIN-SEMANTICS-GATE: grammar, case, application-domain interpretation, unknown handling, and comparison rules require approval |
| DEV-0605 | Relative-path normalization | OWNER_REVIEW | DEV-0602 | To be created | MANIFEST-PATH-GATE: separator, Unicode, dot-segment, traversal, empty/root, canonical comparison, and filesystem-resolution semantics require approval |
| DEV-0606 | Flags and file metadata normalization | OWNER_REVIEW | DEV-0602 | To be created | MANIFEST-FLAGS-GATE: bit meanings, unknown bits, numeric types, and metadata conclusions require sourced characterization and approval |
