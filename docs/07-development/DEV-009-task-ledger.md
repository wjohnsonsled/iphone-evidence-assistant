...
| DEV-0607 | Manifest metadata-blob characterization | READY | DEV-0602; DEV-0606; autonomous Manifest authorization | To be created | Strict bounded syntactic recognition/decoding; unknown classes/fields remain uninterpreted; no support |
