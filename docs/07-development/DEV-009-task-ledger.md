...
| DEV-0604 | Domain normalization | READY | DEV-0602; DEV-0603; autonomous Manifest authorization | To be created | Narrow fail-closed candidate implementation authorized; preserve unknown forms and prohibit activity/existence/support inferences |
