...
| DEV-0602 | Files-table controlled query layer | OWNER_REVIEW | DEV-0601 | To be created | MANIFEST-QUERY-PROVENANCE-GATE: stable row locator, ordering/pagination, duplicate/WITHOUT ROWID behavior, raw file-blob boundary, typed states, and resource/failure semantics require approval |
