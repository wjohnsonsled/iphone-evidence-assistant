...
| FOR-INT-005 | Integrate candidate intake identity, hashing, controlled copies, audit, provenance, cleanup, and failure distinctions without support leakage | ARC-001; DEC-0011; BACKLOG WP-0200 | `IMPLEMENTED_VALIDATION_PENDING` | Test-only composition of DEV-0201 through DEV-0209 and WP-0250 reference services | DEV-0210 synthetic end-to-end suite; QMS-007 | DEV-0210; WP-0200 owner gate |
